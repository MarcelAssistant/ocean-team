    ...
    <div className="space-y-4 max-w-xl">
      ...
      <Card>
        ...
        <div className="space-y-3">
          ...
          <p className="text-[10px]" style={{ color: "var(--text-muted)" }}>Venice: <strong>wan-2.6-text-to-video</strong> (no image) or <strong>wan-2.6-image-to-video</strong> (needs image_url).</p>
        </div>
      </Card>
